const eventsData = [
    {
      id: 1,
      title: { ar: "حفل موسيقي", en: "Music Concert" },
      date: { ar: "25 تشرين الأول 2025", en: "October 25, 2025" },
      location: { ar: "دار الأوبرا", en: "Opera House" },
      description: {
    ...
    {
      id: 2,
      title: { ar: "معرض فنون", en: "Art Exhibition" },
      date: { ar: "10 تشرين الثاني 2025", en: "November 10, 2025" },
      location: { ar: "المتحف الوطني", en: "National Museum" },
      description: {
    ...
    {
      id: 3,
      title: { ar: "مهرجان طعام", en: "Food Festival" },
      date: { ar: "15 كانون الأول 2025", en: "December 15, 2025" },
